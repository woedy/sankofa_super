...
class TransactionDetailModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final timeline = _buildTimeline(statusLabel);
              ...
              child: Column(
                ...
                children: [
                  ...
                  InfoCard(
                    ...
                    child: Column(
                      children: [
                        InfoRow(label: 'Reference ID', value: transaction.id),
                  ...
                  InfoCard(
                    ...
                    child: Column(
                      children: [
                        InfoRow(label: 'Channel', value: _inferChannel()),
                        InfoRow(
                          label: 'Created',
  ...
  List<_TimelineItem> _buildTimeline(String statusLabel) {
    return [
      _TimelineItem(
        icon: Icons.radio_button_checked,
        title: 'Initiated',
        subtitle: DateFormat('dd MMM yyyy • hh:mm a').format(transaction.createdAt),
      ),
      _TimelineItem(
