...
class _DepositFlowScreenState extends State<DepositFlowScreen> {
  ...
  Future<void> _submitDeposit() async {
    ...
    await _showSuccessSheet(amount: amount, fee: fee, newBalance: newBalance, reference: reference);
    if (!mounted) return;
        ...
        return ModalScaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Your wallet was credited instantly. Download the receipt once you connect the backend.',
