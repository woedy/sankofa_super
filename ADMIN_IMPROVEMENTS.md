...
**Test Checklist**
- Resize the viewport and confirm layouts respond without overflow or truncation in both light and dark themes.
- Verify chart tooltips, legends, and axes use accessible colors and typography.
- Cross-check KPI values against the enriched dataset and ensure totals match supporting tables.

### [ ] P1 — Member Operations Suite
...
**Test Checklist**
- Exercise each filter combination and confirm table updates with zero-results states when applicable.
- Trigger each action and verify confirmation modals/toasts render correctly in both themes.
- Ensure drawer layout remains readable on narrow screens (≤480px) and wide desktops (≥1280px).

### [ ] P1 — Group Lifecycle Tools
