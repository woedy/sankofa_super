...
class DisputeSerializer(serializers.ModelSerializer):
    member_name = serializers.CharField(source="member_name", read_only=True)
    ...
    assigned_to_id = serializers.UUIDField(source="assigned_to_id", read_only=True)
    ...
    related_article_id = serializers.UUIDField(source="related_article_id", read_only=True)
