...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def get_wallet(self):
        ...
        Wallet = django_apps.get_model("transactions", "Wallet")
        wallet = Wallet.objects.ensure_for_user(self)
        setattr(self, "wallet", wallet)
        return wallet
    ...
    @property
    def wallet_updated_at(self):
        return self.get_wallet().updated_at
