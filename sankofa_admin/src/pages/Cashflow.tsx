  ...
  return (
    <div className="space-y-6">
      ...
      <Drawer open={drawerOpen} onOpenChange={closeDrawer}>
        <DrawerContent className="sm:left-1/2 sm:w-full sm:max-w-3xl sm:-translate-x-1/2 sm:rounded-t-[24px]">
          {selectedItem && (
            <div className="px-4 py-6 sm:px-8">
              ...
              <DrawerFooter className="mt-6 border-t border-border px-0 pt-4">
