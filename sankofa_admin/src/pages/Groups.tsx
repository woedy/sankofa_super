...
import { z } from 'zod';
import { RefreshCcw, Phone, Plus, UserPlus, Check, X, Trash2, PencilLine } from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <CardDescription>Launch new public circles and oversee their membership pipeline.</CardDescription>
            </div>
                ...
                {groupsQuery.isLoading ? (
                  ...
                  groups.map((group) => (
                    ...
                    >
                      ...
                      <TableCell>{group.owner_name ?? 'Platform managed'}</TableCell>
                      <TableCell>
