...
export default function Groups() {
  ...
  const initialVisibility = (() => {
    ...
    return allowedVisibility.includes((value ?? 'all') as VisibilityFilter)
  ...
  const initialInvite = (() => {
    ...
    return allowedInviteFilters.includes((value ?? 'all') as InviteFilter)
  ...
  }, [inviteFilter, searchQuery, setSearchParams, stageFilter, visibilityFilter]);
  ...
  const groupsQuery = useQuery<PaginatedResponse<AdminGroup>>({
    queryKey: ['admin-groups', searchQuery, visibilityFilter],
  ...
  const emptyState = !groupsQuery.isLoading && filteredGroups.length === 0;
